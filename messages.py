...
MESSAGES: dict[str, dict[Language, str]] = {
    ...
    "label.send": {"ja": "センド", "en": "Send"},
    "label.rename": {"ja": "名前変更", "en": "Rename"},
    "label.device": {"ja": "デバイス", "en": "Devices"},
    "label.fold": {"ja": "折りたたみ", "en": "Fold"},
    "label.monitor": {"ja": "モニター", "en": "Monitor"},
    "label.clip": {"ja": "クリップ操作", "en": "Clip operations"},
    ...
    "error.jev_too_large": {"ja": "Jevに送る情報が多すぎて処理できませんでした。変更はしていません。", "en": "Jev rejected the request because it contained too much information. Nothing was changed."},
    ...
    "error.target_capability": {"ja": "{target}は{action}に対応していません", "en": "{target} does not support {action}."},
    ...
    "error.value_range": {"ja": "その値にはできません（範囲）", "en": "That value is out of range."},
    ...
    "error.return_limit": {"ja": "リターントラックは12本までです", "en": "Live allows at most 12 return tracks."},
    ...
    "llm.auth": {"ja": "Gemini APIキーを確認してください。", "en": "Check your Gemini API key."},
    "llm.configuration": {"ja": "Geminiのキーと設定を確認してください。", "en": "Check your Gemini key and configuration."},
    "llm.quota": {"ja": "Geminiの利用上限に達しました。", "en": "Gemini's usage limit was reached."},
    "llm.unavailable": {"ja": "Geminiに接続できませんでした。", "en": "Gemini was unavailable."},
    "llm.response": {"ja": "わかりませんでした。別の言い方で言ってみてください。", "en": "I could not work that out. Please try saying it another way."},
    ...
    "readback.text.undo_detail": {"ja": "取り消しました: {track} の{action}", "en": "Undone: {track} {action}"},
    ...
    "readback.add_return": {"ja": "リターントラック「{name}」を追加しました", "en": "Added return track “{name}”"},
    ...
    "kind.return_track": {"ja": "リターントラック", "en": "return track"},
    ...
    "ask.plugin": {"ja": "どのプラグインですか？", "en": "Which plug-in?"},
    "ask.plugin_more": {"ja": "どのプラグインですか？（ほか{count}件）", "en": "Which plug-in? ({count} more)"},
    ...
    "info.input_too_long": {"ja": "入力が長すぎます。500文字以内でお願いします", "en": "That command is too long. Keep it to 500 characters or fewer."},
    ...
    "info.cannot_undo": {"ja": "これはLive Jevでは戻せません。Liveの取り消し（⌘Z）をお使いください。", "en": "Live Jev can't undo that. Please use Live's own undo (Cmd+Z)."},
    "info.cannot_redo": {"ja": "これはLive Jevではやり直せません。Liveのやり直し（⇧⌘Z）をお使いください。", "en": "Live Jev can't redo that. Please use Live's own redo (Cmd+Shift+Z)."},
    ...
    "error.script_outdated": {"ja": "Live内のRemote Scriptが古い版です。①セットアップで「更新」→ ②そのあとLive本体を終了して起動し直してください（Live Jevの再起動では入れ替わりません）", "en": "The Remote Script in Live is out of date. 1) Open Setup and press Update. 2) Then quit and reopen Live itself (restarting Live Jev is not enough)."},
    "cli.description": {"ja": "日本語の一言で Ableton Live を操作します", "en": "Control Ableton Live with a short command."},
    "cli.rewritten": {"ja": "言い換え", "en": "Rewritten"},
    "plugin.verify_loading": {"ja": "{plugin} が載ったことを確認できませんでした（Liveが読み込み中かもしれません）", "en": "Could not confirm that {plugin} was loaded. Live may still be loading it."},
    "plugin.verify_failed": {"ja": "{plugin} が載ったことを確認できませんでした", "en": "Could not confirm that {plugin} was loaded."},
    "plugin.not_found": {"ja": "「{name}」に当たるプラグインを見つけられませんでした", "en": "I couldn't find a plug-in matching {name}."},
    ...
    "plugin.load_rejected": {"ja": "Liveがデバイスの読み込みを受け付けませんでした", "en": "Live rejected the device load."},
    "plugin.load_created_track": {"ja": "デバイスの代わりに新しいトラックが作成されたため、処理を中止しました", "en": "Live created a new track instead of loading the device, so the operation stopped."},
    "plugin.instrument_on_non_midi": {"ja": "インストゥルメントはリターンまたはマスターに挿せません", "en": "Instruments cannot be inserted on a return or Master."},
...
ACTION_LABELS: dict[str, dict[Language, str]] = {
    ...
    "rename": {"ja": "名前変更", "en": "Rename"}, "add_midi_track": {"ja": "MIDIトラック追加", "en": "Add MIDI track"}, "add_audio_track": {"ja": "オーディオトラック追加", "en": "Add audio track"}, "add_return_track": {"ja": "リターントラック追加", "en": "Add return track"},
